...
// you must instead have the result be placed in the first part of the array nums. More 
// formally, if there are k elements after removing the duplicates, then the first k elements 
// of nums should hold the final result. It does not matter what you leave beyond the first k
//  elements.
